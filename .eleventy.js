...
async function imageShortcode(src, cls, alt, sizes) {
  ...
  let imageAttributes = {
    class: `lazyload ${cls}`, // Assuming you are using a lazy loading library
    alt,
    sizes,
    loading: "eager", // Adjust loading attribute as needed
    decoding: "async",
  };
...
module.exports = function (eleventyConfig) {
  ...
  eleventyConfig.addFilter("startsWith", function(str, substr) {
  ...
  eleventyConfig.addPassthroughCopy({ 'backend.py': '' });
